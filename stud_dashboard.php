...
<body>
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-12 text-center">
          <h1 style="color: white; margin: 0; white-space: nowrap;">Student Dashboard</h1>
        </div>
  ...
  <div id="left-corner-link">
    <a href="login_students.php">Log out</a>
  </div>
  ...
  <div class="container">
    ...
    <div class="dashboard-links">
      <a href="exam_list.php" id="create-exam-link">
        <img src="cre_ex.png" alt="Create Exam">
        <span>View Exams</span>
      </a>
      <a href="view_results.php" id="view-exam-link">
        <img src="exam-icon.png" alt="View Exam">
        <span>View Marks</span>
      </a>
      <a href="exam_complete.php" id="view-students-link">
